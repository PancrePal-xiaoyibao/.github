...
**现在，我们以【患者关怀场景核心RAG技术和应用研发、患者CLV病情管理场景Skills-hub开发，病情CLV 200+ 管理开源工具库，以及并发症管理工具开源库，专题知识库工具库生态的开发和PR。要感谢那些捐赠社区的公益开发者们！**

**同时，RAG 应用微孵化（"微光成炬"合作计划）】为核心，推动 RAG 和 AI 技术在公益领域的创新应用。**
